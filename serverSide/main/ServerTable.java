   ...
   */
   ...
   public static void main (String[] args)
   {
     ...
     /* get a remote reference to the general repository object */
      ...
      Table table = new Table(reposInterface);                 // Table object
      TableInterface tableInterface = null;                          // remote reference to the Table object

      try
      { tableInterface = (TableInterface) UnicastRemoteObject.exportObject (table, portNumb);
      }
      catch (RemoteException e)
     ...
     /* register it with the general registry service */
      ...
      try
      { reg.bind (nameEntryObject, tableInterface);
      }
      catch (RemoteException e)
