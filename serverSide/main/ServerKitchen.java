    ...
    */
    ...
    public static void main (String[] args)
    {
      ...
      /* get a remote reference to the general repository object */
       ...
       Kitchen kitchen = new Kitchen(reposInterface);                 // kitchen object
       KitchenInterface kitchenInterface = null;                          // remote reference to the kitchen object
 
       try
       { kitchenInterface = (KitchenInterface) UnicastRemoteObject.exportObject (kitchen, portNumb);
       }
       catch (RemoteException e)
      ...
      /* register it with the general registry service */
       ...
       try
       { reg.bind (nameEntryObject, kitchenInterface);
       }
       catch (RemoteException e)
