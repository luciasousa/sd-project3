...
sshpass -f password ssh sd105@l040101-ws08.ua.pt 'cd test/Restaurant/dirRMIRegistry ; cp interfaces/*.class /home/sd105/Public/classes/interfaces ; cp set_rmiregistry_d.sh /home/sd105'
echo "Executing program at the RMIregistry node."
sshpass -f password ssh sd105@l040101-ws08.ua.pt './set_rmiregistry_d.sh sd105 22000'
